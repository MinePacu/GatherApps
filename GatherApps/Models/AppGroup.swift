...
struct AppGroup: Identifiable, Codable, Equatable {
    ...
    var launcherShowsGatherAppsWindow: Bool
    ...
    init(
        ...
        launcherShowsGatherAppsWindow: Bool = false
    ) {
        self.id = id
        self.name = name
        self.apps = apps
        self.iconFileName = iconFileName
        self.launcherShowsGatherAppsWindow = launcherShowsGatherAppsWindow
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case apps
        case iconFileName
        case launcherShowsGatherAppsWindow
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        launcherShowsGatherAppsWindow = try container.decodeIfPresent(
            Bool.self,
            forKey: .launcherShowsGatherAppsWindow
