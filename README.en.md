...
4. Create a group with the `그룹 생성` button in the sidebar.
5. Add apps from the running-app list with the `+` button.
6. Press `그룹 활성화` to bring the grouped app windows forward.
...
- How to generate: click `런처 생성` in the group detail view
